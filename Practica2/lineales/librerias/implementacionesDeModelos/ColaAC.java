...
public class ColaAC <T> implements Cola<T> { 
    ...
    //     // dos atributos primero y ultimo de tipo entero que mantienen una referencia a los indices donde estan situados el primer y ultimo elemento de la cola. 
    //   
    ...
    public void encolar(T e){
        //COMPLETAR
        if (talla==MAX)
            System.out.println("No caben elementos");
        else {
            ultimo = (ultimo +1)%max;
            elArray[ultimo] = x;
            talla++;
